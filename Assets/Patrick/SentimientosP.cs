...
public class SentimientosP : MonoBehaviour
{
    ...
    static public List<float> estadoNormal = new List<float>{        20, 100, 8, 2,    0.005f,  14, 1.5f,  0, 2f,     0, 1,    -1, 100 }; //-1 para infinito
    static public List<float> estadoOdio = new List<float> {         20, 50,  8.5f, 2.5f, 0.005f,  10f, 1,     1, 2,     0, 1.5f,    20, 100 };
